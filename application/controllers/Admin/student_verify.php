...
class Student_verify extends CI_Controller
{
    ...
    $this->load->helper("url");
              ...
              
      {
             ...
             $config = array();
            $config["base_url"] = base_url() . "admin/student_verify/index";
...
$page = 0;
    ...
    $data["results"] = $this->user_model
        ->fetch_verify($config["per_page"], $page);
    ...
    $this->load->view('admin/include/header_view');
         $this->load->view('admin/student_verify_view',$data);
